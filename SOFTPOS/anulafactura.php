...
if($anulada==0)
{
$resultado=$resultado. "<li><div class='f1'>".$idfac."</div><div class='v1'>".$total."</div><div class='d1'>".$fecha."</div><div class='r1'><a href='recibiranu.php?id=".$idfac."'>Anular</a></div></li>
";
}
else
{
