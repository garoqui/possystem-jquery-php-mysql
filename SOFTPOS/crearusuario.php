	...
	<div class="cajaform">
		...
		<div class="form-group form-row-wide">
          ...
          <div id="botonera">
             ...
             <form id="ajax-contact-form" action='insertusu.php' class="form-horizontal"  method='post' enctype ="multipart/form-data" >
      <div class="cajaprod">
...
<!-- end foto -->
                    ...
                    <div class="controls">				      
                      ...
                      <input class="tprod" id="alias" name="alias" placeholder="Alias:"  type="text">
                       <input class="tprod" id="pass" name="pass" placeholder="Contraseña:"  type="password">
                       <input class="tprod" id="conf" name="conf" placeholder="Repita Contraseña:"  type="password">
                       <div><label>Seleccione el Cargo: </label><select id="cargo" name="cargo">
