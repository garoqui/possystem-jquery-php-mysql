...
$resultado="<ul><li><div class='f1e'>Entrada</div><div class='v1e'>Cantidad</div><div class='d1e'>Fecha</div><div class='r1e'>Acción</div></li>";
...
$resultado=$resultado. "<li><div class='f1'>".$idfac."</div><div class='v1'>".$total."</div><div class='d1'>".$fecha."</div><div class='r1'><a href='recibirreiment.php?id=".$idfac."'>Reimprimir</a></div>
