...
<script type="text/javascript" src="js/insertarprod1.js"></script>-->
...
<div id="seleccion">
	...
	<div class="cajaform">
       ...
       <div id="botonera">
             ...
             <form id="ajax-contact-form" action='insertprod.php' class="form-horizontal"  method='post' enctype ="multipart/form-data" >
      <div class="cajaprod">
