...
<script type="text/javascript" src="js/modificarentrada.js"></script>
...
<li id="menu-item-2188" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-2188"><a href="mantenimiento.php" id="mantenimiento">Mantenimiento</a>
  <ul class="sub-menu" id="subman">
    ...
    <li id="menu-item-2191" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-2191"><a href="anular.php">Anular Factura</a>
...
<div id='busquedacont'>
  <h2>BUSCAR</h2>
  <form name="busqueda" method='POST' ID="busqueda">
  
  <div>Fecha Inicial: <input type="text" id="datepicker" name="datepicker"></div>
  <div>Fecha Final: <input type="text" id="datepicker1" name="datepicker1"></div>
  <p><input type='button' value='Buscar' id='btnbuscar'></p>
</form></div>
<div id='entradas'></div>
